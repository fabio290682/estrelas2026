...
> {
  ...
  static getDerivedStateFromError(error: unknown): ErrorBoundaryState {
    ...
    npx expo install expo-updates expo-routercomponentDidCatch(error: unknown, errorInfo: React.ErrorInfo): void {
    this.setState({ error });
...
function routercomponentDidCatch(error: any, unknown: any, errorInfo: any, ErrorInfo: any) {
